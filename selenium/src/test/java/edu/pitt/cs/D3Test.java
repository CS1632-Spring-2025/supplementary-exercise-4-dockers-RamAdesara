...
public class D3Test {
  ...
  public void dEFECT1FUNFEED() {
    ...
    // 8 | waitForElementVisible | xpath=//*[@id='feedResult'] | 30000
    {
  ...
  public void dEFECT1FUNGREETACAT() {
    ...
    // 9 | assertText | xpath=//*[contains(text(), 'Meow!Meow!')] | Meow!Meow!
  ...
  public void dEFECT1FUNGREETACATWITHNAME() {
    // Test name: DEFECT1-FUN-GREET-A-CAT-WITH-NAME
    // Step # | name | target | value
    // 1 | open | http://localhost:8080/ | 
    driver.get("http://localhost:8080/");
    // 2 | setWindowSize | 884x827 | 
    ...
    // 7 | click | xpath=//button[contains(.,'Rent')] | 
    driver.findElement(By.xpath("//button[contains(.,\'Rent\')]")).click();
    // 8 | open | /greet-a-cat/Jennyanydots | 
    driver.get("http://localhost:8080//greet-a-cat/Jennyanydots");
    // 9 | assertText | xpath=//*[contains(text(), 'Jennyanydots is not here.')] | Jennyanydots is not here.
    assertThat(driver.findElement(By.xpath("//*[contains(text(), \'Jennyanydots is not here.\')]")).getText(), is("Jennyanydots is not here."));
  }
  @Test
